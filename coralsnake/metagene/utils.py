...
#
# Common utilities for the coralsnake metagene subcommand.
# Migrated from the standalone `metagene` package into coralsnake.
...
def print_analysis_summary(params: dict) -> None:
    ...
    logger.info(
        f"Number of bins: {params.get('bin_number', params.get('bins', 'N/A'))}"
    )
