...
def main():
    ...
    i_dirs = ["tests/benchmark/test_idx_only/genes_idx", "tests/benchmark/test_idx_only/transcript_idx"]
    ...
    it = read_paired_fastx("tests/benchmark/trimmed_R1_100k.fq.gz", "tests/benchmark/trimmed_R2_100k.fq.gz")
    batch = []
    for _ in range(2000):
        r1, r2 = next(it)
        batch.append(((r1.name, r1.sequence, r1.quality), (r2.name, r2.sequence, r2.quality)))
